...
function MaxNewman(props) {
    ...
    return (
        ...
        <h1 style={{textAlign: 'left', color:'black', paddingLeft: '2%'}}>After the War</h1>
            <p style={{textAlign: 'left', color:'black', paddingLeft: '2%', paddingBottom: '5%'}}>Despite its origins in wartime engineering Max Newman's creations were able to develop into commercializable uses. 
